...
// int	key_hookK(int keycode, t_vars *v)
// {
...
// 			if (v->map->content[mapY] != NULL && v->map->content[mapY][mapX] != 0 && v->map->content[mapY][mapX] != '0') 
// 				hit = 1;
// 		} 
...
// 		// 	index++;
// 		// }
// 		draw_verline(&v->img, x, drawStart, drawEnd, 255);
// 		// free(buf);
// 		v->time++;
