SRC = main.c ./renderer/main.c ./utils/tools.c ./utils/mlx.c ./parcing/parc_map.c ./parcing/parc_filename.c ./parcing/parc_content.c ./parcing/parc_content_2.c ./parcing/parc_colors.c ./parcing/parc_elements.c ./parcing/parc_texture.c ./utils/gnl/get_next_line.c
